    ...
    const orderList = items.map((product, index) => {
        return(
            <Grid style={{ marginTop: '30px', marginBottom: '30px' }}>
                ...
                <Header as='h3'>Price: {product.price * product.quantity}</Header>
            </Grid>
        )
    })
                        ...
                        <Card.Content >
                            <Form onSubmit={ handleInformation }>
                                <Form.Field required>
                                    ...
                                    <input type="text" name='fullName' onChange={ handleChange } placeholder='Enter your name' pattern="[A-Za-z]{2,} [A-Za-z]{2,}" title="Ex. Md Jehan" />
                                </Form.Field>
                                <Form.Field required>
                                    <label>Phone Number</label>
                                    <input type="tel" name='phone' onChange={ handleChange } placeholder="01XXXXXXXXX" pattern="01[0-9]{9}" title="Ex. 01926759232" />
                                </Form.Field>
